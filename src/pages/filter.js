...
export const Filter = () => {
  ...
  return (
    <div className="h-[100vh] border border-[red] flex justify-center items-center">
        <div
  class=" max-w-md rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
  <form>
