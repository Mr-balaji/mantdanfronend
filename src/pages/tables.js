            ...
            <>
                <div className="flex justify-between w-[30%] ">
                    <div className="px-4  bg-[#ddd2d2] rounded-md ">
                        <button className="bg-[#ddd2d2] text-[black]" onClick={() => editClick(rowData._id)}>Edit</button>
                    </div>
                    <div className="px-4  bg-[#8c3535] rounded-md ml-3 text-[#fff]">
                        <button className="bg-[#8c3535]" onClick={() => deleteRecord(rowData._id)}>Delete</button>
                    </div>
                </div>
            </>
        )
                                ...
                                <>
                                    <div className="mt-12 mb-8 flex flex-col gap-12">
                                        ...
                                        <div className="card relative tablediv">
                                            ...
                                            <DataTable value={tableData} paginator scrollable frozenWidth="200px" stripedRows rows={10} dataKey="id" filterDisplay="row" loading={loading}
